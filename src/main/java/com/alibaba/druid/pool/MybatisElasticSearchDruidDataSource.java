...
public class MybatisElasticSearchDruidDataSource extends ElasticSearchDruidDataSource {
    ...
    public MybatisElasticSearchDruidDataSource() {
        this(false);
    }

    public MybatisElasticSearchDruidDataSource(boolean fairLock) {
        super(fairLock);
    ...
    private DruidPooledConnection getConnectionInternal(long maxWait) throws SQLException {
        ...
        DruidPooledConnection poolalbeConnection = new MybatisElasticSearchDruidPooledConnection(holder);
    ...
    public void registerMbean() {
        if (!mbeanRegistered) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                @Override
                public Object run() {
                    ObjectName objectName = DruidDataSourceStatManager.addDataSource(MybatisElasticSearchDruidDataSource.this,
                            MybatisElasticSearchDruidDataSource.this.name);

                    MybatisElasticSearchDruidDataSource.this.setObjectName(objectName);
                    MybatisElasticSearchDruidDataSource.this.mbeanRegistered = true;
    ...
    public void unregisterMbean() {
        if (mbeanRegistered) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                @Override
                public Object run() {
                    DruidDataSourceStatManager.removeDataSource(MybatisElasticSearchDruidDataSource.this);
                    MybatisElasticSearchDruidDataSource.this.mbeanRegistered = false;
                    return null;
                }
            });
        }
    ...
    protected void put(Connection connection) {
        ...
        try {
            holder = new DruidConnectionHolder(MybatisElasticSearchDruidDataSource.this, connection);
        } catch (SQLException ex) {
            lock.lock();
            try {
                if (createScheduler != null) {
